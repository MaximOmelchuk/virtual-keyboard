import {arrIndexFixed, arrIndexWide, arrButtonValuesFixed, arrButtonValuesEn,
        arrButtonValuesRu, arrButtonValuesEnCaps, arrButtonValuesRuCaps, arrButtonValuesEnShift,
        arrButtonValuesRuShift, arrButtonValuesShiftCapsEn, arrButtonValuesShiftCapsRu} from './data.js';

let currentLang = 'en', arrButtonValuesCommon;
...
fixedArr.forEach((x, i) => {
  x.innerHTML = arrButtonValuesFixed[i];
});
